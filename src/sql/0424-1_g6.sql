...
insert  into `ACTIVITY`(`ID`,`NAME`,`IMG`,`OPACITY`,`STATE`,`TIME`,`S1_START`,`S1_END`,`S2_START`,`S2_END`,`S3_START`,`S3_END`,`DESC`,`CATEGORY_ID`) values 
(1,'我要當牛仔','./img/activity/riding.jpg',25,'上架中',90,'09:30','11:00','13:00','14:30','16:30','18:00','無論你是大朋友小朋友、初學者，都可以安心做牛仔！* 身高 90 公分以下且與陪同成人體重相加總重不超過 80 公斤的兒童可以與成人一起乘坐。',6),
(2,'小豬賽跑','./img/activity/pigrun.jpg',20,'上架中',30,'10:00','10:30','13:00','13:30','15:00','15:30','看穿著號碼衣的小豬們，翹著屁股碰碰跳跳的向前賽跑，觀賽前可以先將自己神聖的一票投給喜歡的小豬，比賽結束後，若您投的小豬是冠軍，就可獲得牧場的驚喜小禮物呦！',5),
(3,'剃羊毛秀','./img/activity/fur.jpg',50,'上架中',60,'09:30','10:30','13:00','14:00','17:00','18:00','想知道服裝織品中常見的羊毛，最開始的原型是什麼樣子嗎？讓我們專業的剃羊毛技師為你們揭開這層面紗，攜手一探究竟吧。',1),
(4,'馬術秀','./img/activity/horseshow.jpg',50,'上架中',60,'11:00','12:00','13:00','14:00','16:00','17:00','由專業的騎士親自演出，在駿馬馬背上站立、翻騰、跳躍，甚至是高難度的射箭。精彩的馬術秀絕對不容錯過，快來一睹馬兒們的神勇風采吧。',6),
(5,'草泥馬散步秀','./img/activity/alpacawalk.jpg',20,'上架中',90,'10:30','11:30','13:30','14:30','15:30','16:30','跟著草泥馬在遼闊的草原，與和煦陽光的陪伴下，踏著慵懶的步伐，一同遠離塵囂，享受著屬於你我間的怡然時光吧。',3),
...
(23,3,27,'2022-05-06','09:30~10:30',3,'2022-04-24 11:27:11'),
(26,3,27,'2022-05-07','09:30~10:30',5,'2022-04-24 11:35:38'),
(27,3,27,'2022-05-06','13:00~14:00',5,'2022-04-24 11:36:23');
