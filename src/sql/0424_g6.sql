...
insert  into `ACTIVITY`(`ID`,`NAME`,`IMG`,`OPACITY`,`STATE`,`TIME`,`S1_START`,`S1_END`,`S2_START`,`S2_END`,`S3_START`,`S3_END`,`DESC`,`CATEGORY`) values 
(1,'我要當牛仔','./img/activity/riding.jpg',25,'上架中',90,'09:30','11:00','13:00','14:30','16:30','18:00','無論你是大朋友小朋友、初學者，都可以安心做牛仔！* 身高 90 公分以下且與陪同成人體重相加總重不超過 80 公斤的兒童可以與成人一起乘坐。','horse'),
(2,'小豬賽跑','./img/activity/pigrun.jpg',20,'上架中',30,'10:00','10:30','13:00','13:30','15:00','15:30','看穿著號碼衣的小豬們，翹著屁股碰碰跳跳的向前賽跑，觀賽前可以先將自己神聖的一票投給喜歡的小豬，比賽結束後，若您投的小豬是冠軍，就可獲得牧場的驚喜小禮物呦！','pig'),
(3,'剃羊毛秀','./img/activity/fur.jpg',50,'上架中',60,'09:30','10:30','13:00','14:00','17:00','18:00','想知道服裝織品中常見的羊毛，最開始的原型是什麼樣子嗎？讓我們專業的剃羊毛技師為你們揭開這層面紗，攜手一探究竟吧。','sheep'),
(4,'馬術秀','./img/activity/horseshow.jpg',50,'上架中',60,'11:00','12:00','13:00','14:00','16:00','17:00','由專業的騎士親自演出，在駿馬馬背上站立、翻騰、跳躍，甚至是高難度的射箭。精彩的馬術秀絕對不容錯過，快來一睹馬兒們的神勇風采吧。','horse'),
(5,'草泥馬散步秀','./img/activity/alpacawalk.jpg',20,'上架中',90,'10:30','11:30','13:30','14:30','15:30','16:30','跟著草泥馬在遼闊的草原，與和煦陽光的陪伴下，踏著慵懶的步伐，一同遠離塵囂，享受著屬於你我間的怡然時光吧。','alpaca'),
(11,'DIY ㄋㄟㄋㄟ 肥皂','./img/activity/soap.jpg',30,'上架中',90,'09:30','11:00','13:00','14:30','16:00','17:30','喜歡洗澡嗎 ? 簡單三步驟就能讓你完成屬於自己的肥皂 ，讓Sìkha肥皂滲透你的肌膚，享受肌膚絲緞般的觸感，自用送禮兩相宜，還不快來體驗！','sheep'),
(21,'擠ㄋㄟㄋㄟ','./img/activity/milkmaker.jpg',20,'上架中',30,'09:00','09:30','10:00','10:30','14:00','14:30','幫乳牛媽媽擠ㄋㄟㄋㄟ，讓小朋友們知道，原來牛奶是從這裡來的呢！。透過工作人員教學說明後，我們可以親手擠出白色的牛奶，配合乳牛媽媽的生理時間，提供每日３個場次可以體驗喔！','cow'),
(31,'DIY ㄋㄟㄋㄟ 餅乾','./img/activity/makecookie.jpg',30,'上架中',90,'09:30','11:00','13:00','14:30','16:30','18:00','奶味香濃的餅乾大人小孩都喜歡！但有親手做過餅乾嗎？Sìkha牧場提供新鮮牛奶讓各位大朋友小朋友來這親手製作出香濃可口的ㄋㄟㄋㄟ餅乾 ! ? 簡單三步驟就能讓你完成屬於自己的肥皂 ，讓Sìkha肥皂滲透你的肌膚，享受肌膚絲緞般的觸感，自用送禮兩相宜，還不快來體驗！','cow'),
(32,'小鹿相見歡','./img/activity/playwithdeer.jpg',20,'上架中',30,'09:00','09:30','11:00','11:30','14:00','14:30','大朋友小朋友趕快來Sìkha牧場與可愛親人的梅花鹿近距離互動，並拍照留下紀念吧！','deer');
...
(1,1,19,'2022-05-06','09:30~11:00',3,'2022/04/17 18:22:23'),
(2,1,22,'2022-05-06','09:30~11:00',2,'2022/04/17 18:22:24'),
(3,1,25,'2022-05-06','13:00~14:30',2,'2022/04/18 09:35:08'),
(4,1,20,'2022-05-07','16:30~18:00',5,'2022/04/18 14:28:15'),
(5,2,19,'2022-05-06','13:00~13:30',3,'2022/04/17 18:45:21'),
(6,2,23,'2022-05-07','15:00~15:30',4,'2022/04/17 16:27:44'),
(7,2,25,'2022-05-06','10:00~10:30',2,'2022/04/17 19:50:35'),
(8,2,24,'2022-05-08','10:00~10:30',3,'2022/04/16 09:29:45'),
(9,3,19,'2022-05-06','17:00~18:00',3,'2022/04/17 19:29:23'),
(10,3,26,'2022-05-08','09:30~10:30',5,'2022/04/18 20:12:09'),
(11,3,20,'2022-05-07','09:30~10:30',3,'2022/04/19 16:35:52'),
(12,1,27,'2022-05-07','13:00~14:30',6,'2022/04/14 16:35:34'),
(13,1,24,'2022-05-08','13:00~14:30',3,'2022/04/16 09:29:10'),
(14,1,21,'2022-05-08','09:30~11:00',2,'2022/04/18 15:12:34'),
(15,1,26,'2022-05-08','13:00~14:30',5,'2022/04/18 20:35:48'),
(16,4,25,'2022-05-06','11:00~12:00',2,'2022/04/23 11:20:01'),
(17,5,22,'2022-05-06','13:30~14:30',2,'2022/04/23 11:23:09'),
(18,11,25,'2022-05-06','13:00~14:30',2,'2022/04/23 11:24:13'),
(19,21,20,'2022-05-07','14:00~14:30',3,'2022/04/23 11:25:34'),
(20,31,23,'2022-05-07','16:30~18:00',4,'2022/04/23 11:26:32'),
(21,32,23,'2022-05-07','09:00~09:30',4,'2022/04/23 11:29:29');
